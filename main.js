...
tax_rate= 15;
tax_rate=20;
document.getElementById("quiz1").innerHTML = "age is: " + age + " and tax_rate: " + tax_rate;
console.log("age is: " + age + " and tax_rate: " + tax_rate);
...
function myfunction () {
    ...
    document.getElementById("quiz2").innerHTML = sum ;
    console.log (sum) ;
...
let n1 = new Array(numbers);
let n2 =new Array(numbers);
...
for (i=0;i < string1.length && i < string2.length; i ++)
    n1[string1[i].charCodeAt(0)] ++
    n2[string1[i].charCodeAt(0)] ++
